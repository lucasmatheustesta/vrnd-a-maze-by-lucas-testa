...
Developed by Lucas Testa
The project is a maze developed in Unity, where the goal is to find a key to open a temple, and to collect the maximum number of coins.
