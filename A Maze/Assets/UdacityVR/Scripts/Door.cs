...
public class Door : MonoBehaviour {
	...
	void Start () {
        ...
        leftDoorEndRotation = leftDoorStartRotation * Quaternion.Euler(0f, 0f, -180f);
        ...
        rightDoorEndRotation = rightDoorStartRotation * Quaternion.Euler(0f, 0f, -180f);
	}
    ...
    public void OnDoorClicked() {
        ...
        if (!locked)
        {
            opening = true;
            audioSource.Play();
            //BoxCollider[] colls = gameObject.GetComponentsInChildren<BoxCollider>();
            //for (int componentIndex = 0; componentIndex < colls.Length; ++componentIndex)
            //{
            //    colls[componentIndex].enabled = false;
            //}
        }
